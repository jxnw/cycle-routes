...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.8\textwidth,trim={22cm 10cm 0 0},clip]{plan_images/osm.png}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[ht]{0.7\textwidth}
        \centering
        \includegraphics[width=\textwidth,trim={2.5cm 1.5cm 1.7cm 1.7cm},clip]{plan_images/cycle_friendly.png}
    ...
    \begin{subfigure}[ht]{0.7\textwidth}
        \centering
        \includegraphics[width=\textwidth,trim={1cm 1cm 1cm 1cm},clip]{plan_images/cycle_friendly_new.png}
...
\begin{enumerate}
    ...
    \item \textit{Apply the heuristics to highlight disconnected components in the cycle-friendly subgraph}
