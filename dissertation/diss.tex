...
\begin{figure}[ht]
    \centering
    \includesvg[width=0.9\textwidth]{diss_images/images_st_andrews/components.svg}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[ht]{0.47\textwidth}
        \centering
        \includesvg[width=\textwidth]{diss_images/images_st_andrews/path_overall.svg}
    ...
    \begin{subfigure}[ht]{0.47\textwidth}
        \centering
        \includesvg[width=\textwidth]{diss_images/images_st_andrews/path_town_centre.svg}
    ...
    \begin{subfigure}[ht]{0.47\textwidth}
        \centering
        \includesvg[width=\textwidth]{diss_images/images_st_andrews/path_local_centre.svg}
    ...
    \begin{subfigure}[ht]{0.47\textwidth}
        \centering
        \includesvg[width=\textwidth]{diss_images/images_st_andrews/path_existing.svg}
